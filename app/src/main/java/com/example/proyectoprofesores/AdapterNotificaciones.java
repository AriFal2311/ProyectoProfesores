    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            case VIEW_TYPE_1:
                ...
                Glide.with(context).load(listNotificaciones.get(position).imageNotificaciones).into(holder1.imgNotificaciones);
            ...
            case VIEW_TYPE_2:
                ...
                Glide.with(context).load(listNotificaciones.get(position).imageNotificaciones).into(holder2.imgNotificaciones);
